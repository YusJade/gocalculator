...
func (x *CalculateResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
const file_calculator_proto_rawDesc = "" +
	"\n" +
	"\x10calculator.proto\x12\x0fcalculatorpb.v1\"2\n" +
	"\x10CalculateRequest\x12\x1e\n" +
	"\n" +
	"expression\x18\x01 \x01(\tR\n" +
	"expression\"Y\n" +
	"\x11CalculateResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x16\n" +
	"\x06result\x18\x02 \x01(\x02R\x06result\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage2g\n" +
	"\x11CalculatorService\x12R\n" +
	"\tCalculate\x12!.calculatorpb.v1.CalculateRequest\x1a\".calculatorpb.v1.CalculateResponseB*Z(github.com/YusJade/gocalculator/genprotob\x06proto3"
